...
case "$install_command" in
  *"npm install -g"*"@direxio/connent@1.3.9"*"direxio-connect"*"daemon install"*"--config"*"im.example.test/cc-connect/config.toml"*"--service-name"*"im.example.test"*"--force"*) ;;
  *)
...
[[ "$guidance" == *"@direxio/connent@1.3.9"* || "$install_command" == *"@direxio/connent@1.3.9"* ]]
